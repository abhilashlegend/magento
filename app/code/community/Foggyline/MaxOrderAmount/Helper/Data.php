<?php
	...
	*/
	class Foggyline_MaxOrderAmount_Helper_Data extends Mage_Core_Helper_Abstract
	{
		...
		const XML_PATH_SINGLE_ORDER_TOP_AMOUNT = 'sales/foggyline_maxorderamount/single_order_top_amount';
		const XML_PATH_SINGLE_ORDER_TOP_AMOUNT_MSG = 'sales/foggyline_maxorderamount/single_order_top_amount_msg';
		...
		{
			return 
			(int)Mage::getStoreConfig(self::XML_PATH_SINGLE_ORDER_TOP_AMOUNT, $store);
		}

		public function getSingleOrderTopAmountMsg($store = null) {
			return 
				Mage::getStoreConfig(self::XML_PATH_SINGLE_ORDER_TOP_AMOUNT_MSG, $store);
		}
	}
?>